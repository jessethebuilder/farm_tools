...
RSpec.describe NewsStoriesController, type: :controller do
  ...
  # NewsStory. As you add validations to NewsStory, be sure to
  ...
  # NewsStoriesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all news_stories as @news_stories" do
      news_story = NewsStory.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:news_stories)).to eq([news_story])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new news_story as @news_story" do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new NewsStory" do
        expect {
          post :create, {:news_story => valid_attributes}, valid_session
        }.to change(NewsStory, :count).by(1)
      end

      it "assigns a newly created news_story as @news_story" do
        post :create, {:news_story => valid_attributes}, valid_session
        expect(assigns(:news_story)).to be_a(NewsStory)
        expect(assigns(:news_story)).to be_persisted
      end

      it "redirects to the created news_story" do
        post :create, {:news_story => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved news_story as @news_story" do
        post :create, {:news_story => invalid_attributes}, valid_session
        expect(assigns(:news_story)).to be_a_new(NewsStory)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested news_story" do
        news_story = NewsStory.create! valid_attributes
        put :update, {:id => news_story.to_param, :news_story => new_attributes}, valid_session
        news_story.reload
      ...
      it "assigns the requested news_story as @news_story" do
        news_story = NewsStory.create! valid_attributes
        put :update, {:id => news_story.to_param, :news_story => valid_attributes}, valid_session
        expect(assigns(:news_story)).to eq(news_story)
      end

      it "redirects to the news_story" do
        news_story = NewsStory.create! valid_attributes
        put :update, {:id => news_story.to_param, :news_story => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns the news_story as @news_story" do
        news_story = NewsStory.create! valid_attributes
        put :update, {:id => news_story.to_param, :news_story => invalid_attributes}, valid_session
        expect(assigns(:news_story)).to eq(news_story)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested news_story" do
      news_story = NewsStory.create! valid_attributes
      expect {
