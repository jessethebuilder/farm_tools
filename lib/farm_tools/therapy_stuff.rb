module TherapyStuff
  ::CATEGORIES = {'pt' => {:name => 'Physical Therapist', :profession => 'Physical Therapy', :tj => 'Physical Therapy'},
                  'ot' => {:name => 'Occupational Therapist', :profession => 'Occupational Therapy', :tj => 'Occupational Therapy'},
                  'slp' => {:name => 'Speech Language Pathologist', :profession => 'Speech Language Pathology', :tj => 'Speech Therapy'},
                  'pta' => {:name => 'Physical Therapy Assistant', :profession => 'Physical Therapy Assistant', :tj => 'Physical Therapist Assistant'},
                  'cota' => {:name => 'Certified Occupational Therapy Assistant', :profession => 'Occupational Therapy Assistant', :tj => 'Certified Occupational Therapy Assistant'},
